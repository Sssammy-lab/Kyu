...
document.addEventListener('DOMContentLoaded', function(){
    ...
    t_kash.addEventListener('click', function(){
       ...
       a_money.style=a_money.dataset.originalStyle;
        ...
        number_l.dataset.originalStyle=number_l.textContent;
        ...
        submit.addEventListener('click', function(){
            ...
            username.value='';
            amount.value='';
            number_l.textContent=number_l.dataset.originalStyle;
            submit.innerHTML='PAID';
           }
    ...
    mpesa.addEventListener('click', function(){
       ...
       a_money.style=a_money.dataset.originalStyle;
        ...
        amountl.textContent='AMOUNT:';
        submit.textContent='PAY NOW:';
        number_l.dataset.originalText=number_l.textContent;
